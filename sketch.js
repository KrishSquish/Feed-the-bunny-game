...
function setup() {
  ...
  rope2 = new Rope(4,{x:400,y:220})
  ground = new Ground(w/2,h,w,20);

  blink.frameDelay = 20;
  eat.frameDelay = 20;

  bunny = createSprite(220,h-70,100,100);
  bunny.scale = 0.2;
